...
class WeekView extends StatelessWidget {
  ...
  Widget _buildDayCell(BuildContext context, String date, String day,
      bool isLogged, bool isDayYet) {
      ...
      Stack(alignment: Alignment.center, children: [
        ...
        Opacity(
          ...
          child: FitnessIcon(
            type: isDayYet
                ? isLogged
                    ? FitnessIconType.calendar_slot_logged
                    : FitnessIconType.calendar_slot
                : FitnessIconType.calendar_slot_unlogged,
            size: 48,
          ),
        ),
      ]),
